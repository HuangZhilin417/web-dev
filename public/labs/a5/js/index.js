...
let title = 'Legacy ES5 function'
console.log(title);
const twoPlusFour = add(2, 4);
console.log(twoPlusFour);


title = 'New ES6 functions'
console.log(title);
const subtract = (a, b) => {
    return a - b;
}
...
title = 'Parenthesis and parameters'
console.log(title);
const square = a => a * a;
const plusOne = a => a + 1;
...
console.log(`(${variableArray1.length})[${variableArray1}]`)

console.log(`${variableArray1[0]}`)
console.log(`${variableArray1[1]}`)
console.log(`${variableArray1[2]}`)
console.log(`(${variableArray1[3].length})[${variableArray1[3]}]`)
console.log(`(${variableArray1[4].length})[${variableArray1[4]}]`)

title = 'Array index and length'
console.log(title);
...
title = 'Add and remove data to arrays'
console.log(title);
// adding new items
numberArray1.push(6);
